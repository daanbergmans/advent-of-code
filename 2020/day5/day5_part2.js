...
let mySeatId = seatIds.sort().filter((sId, index) => {
    return seatIds[seatIds[index - 1]] && seatIds[seatIds[index + 1]] && sId + 1 !== seatIds[index + 1]
});

console.log("My seat ID is: " + (parseInt(mySeatId) + 1));
